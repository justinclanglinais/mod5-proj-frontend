      ...
      <div className="App">
        <Router>
          <div>
            ...
            <Route
              exact path="/" 
              render={() => <h1>Jiu-Jitsu Class Management Home Page</h1>} 
            />
            {this.state.loggedIn ? 
              <Route exact path="/dashboard" 
                render={() => 
                  <Dashboard user={this.state.auth.user.user} deleteEnrollment={this.deleteEnrollment} />}
              /> :
              null}
            <Route 
              exact path="/signup" 
              ...
              <Route 
                ...
                render={routerProps => 
                  <ClassIndex 
                    ...
                    signUpSession={this.signUpSession} 
                    user={this.state.auth.user.user} 
                  />} 
              /> :
              null}
            <Route 
